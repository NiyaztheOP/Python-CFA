...
const products = [
    ...
    colors: [
      {
        ...
        productDesc: "The Air Force 1 was created by designer Bro Akmal and was the first shoe to be used by the air force.",
  ...
  },
  {
    ...
    colors: [
      {
        code: "white",
        img: "./img/Product/rockey.png",
        productDesc: "The ROCKEY was first released in 1987 and designed by CRAZY MAn, making history as the first shoe to feature ROcket technology."
      },

      {
        code: "black",
        img: "./img/Product/rocket2.png",
        productDesc: "The ROCKEY was first released in 1987 and designed by CRAZY MAn, making history as the first shoe to feature ROcket technology."
      }
    ],
  },
